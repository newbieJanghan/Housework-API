...
public class WorkoutStatController {
    ...
    @Authenticate
    @GetMapping("/my")
    public WorkoutStat getUserWorkoutStat(@RequestUser CurrentUser user, DateQueryParams dateQuery) throws BadRequestException {
    ...
    public List<WorkoutStat> getFamilyWorkoutStats(@RequestUser CurrentUser user, DateQueryParams dateQuery) throws BadRequestException {
